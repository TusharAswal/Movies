...
import INFO from '../component/TABS_DETAILS/INFO';
import CAST from '../component/TABS_DETAILS/CAST';
import REVIEW from '../component/TABS_DETAILS/REVIEW';
        ...
        return (
            <View style={{ flex: 1, }}>
                ...
                <View style={{ flex: 0.5, }}>
                    ...
                    <TouchableOpacity onPress={this.onOpen.bind(this)} style={{ flex: 0.35, position: 'absolute', marginLeft: width(80) }}>
                        <Icon name='share' size={height(4)} color='white' style={{ marginLeft: width(2), marginTop: width(2) }} />
                    </TouchableOpacity>
                    <Menu style={{ flex: 0.25, position: 'absolute', marginLeft: width(93) }} >
                        <MenuTrigger>
                            <Icon name='ellipsis-v' size={height(4)} color='white' style={{ marginLeft: width(2), marginTop: width(2) }} />
                        </MenuTrigger>
                        <MenuOptions>
                            <MenuOption onSelect={() => alert(`Google Play Store`)} text='Google Play Store' />
                            <MenuOption onSelect={() => alert(`View on Tmdb`)} text='View on Tmdb' />
                            <MenuOption onSelect={() => alert(`View on IMDbb`)} text='View on IMDb' />
                            <MenuOption onSelect={() => alert(`Join The Discussion`)} text='Join The Discussion' />
                        </MenuOptions>
                    </Menu>
