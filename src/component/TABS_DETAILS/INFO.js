...
class INFO extends Component {
    ...
    componentDidMount() {
    //console.log("EXTRA DETAILS",this.props.data.info)
    ...
    componentWillReceiveProps=(nextProps)=> {
       // console.log('generes updated',nextProps.ReBuRe.genres[0].name)
        //console.log('Directorsssssssss',nextProps.director.crew)
        ...
        // if(this.props.generes!=nextProps.generes){
        //     this.setState({generes:nextProps.ReBuRe.genres.name})
        // }
    }
