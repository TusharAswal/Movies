...
import { Linking, Text, View, ScrollView, FlatList, TouchableOpacity, ActivityIndicator, WebView } from 'react-native';
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) =>
                                ...
                                <View style={{ alignItems: 'center', flexWrap: 'wrap', marginLeft: width(3), marginRight: width(3), marginTop: height(2) }}>
                                    ...
                                    <WebView
                                        source={{ uri: YOUTUBE + item.key }}
                                        mediaPlaybackRequiresUserAction={true}
                                        allowsInlineMediaPlayback={false}
                                        scrollEnabled={false}
                                        style={{ marginTop: 20, width: 300, height: 300, borderWidth: 1 }}
                                    />
                                </View>
