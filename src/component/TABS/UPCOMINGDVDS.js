...
class UPCOMINGDVDS extends React.Component {
                ...
                {this.props.singleRow ?
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', flex: 0.2, alignContent: 'center', alignItems: 'center', backgroundColor: '#C0C0C0', width: width(30) }}>
                    <View style={{ flex: 0.8, flexWrap: 'wrap' }}>
                      <Text style={{ fontSize: 12, textAlign: 'left', color: '#000', marginLeft: totalSize(1) }} numberOfLines={2}>{item.title}</Text>
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(UPCOMINGDVDS);